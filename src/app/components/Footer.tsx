...
const Footer = () => {
  return (
    <footer className="bg-[#042c46] text-white py-20 dark:bg-slate-950">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16 sm:pl-32">
          ...
          <div className="flex flex-col items-start max-w-xs">
            ...
            <div className="flex items-center mb-3">
              ...
              <div className="bg-[#FB823A] p-3 mr-4 rounded-full">
          ...
          <div className="flex flex-col items-start max-w-xs">
            ...
            <button className="mt-6 bg-[#FB823A] text-white py-3 px-6 hover:bg-orange-600 transition-all duration-300">
              Review us
            </button>
          </div>
