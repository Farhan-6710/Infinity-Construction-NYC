    ...
    <section className="flex justify-center items-center bg-white dark:bg-slate-950 p-6 pt-0 pb-6 sm:pb-20">
      <div className="max-w-5xl w-full">
        ...
        >
          ...
          services in the tri-state area. With a focus on precision,
          punctuality, and professionalism, we specialize in brownstone exterior
          restoration, masonry, roofing, waterproofing, fire escape painting,
          and painting & plastering. Our goal is to deliver exceptional results
        ...
        >
          ...
          highly experienced team of workers, we take pride in our attention to
          detail and the quality of our work.
        </p>
