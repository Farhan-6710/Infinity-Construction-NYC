...
const Footer = () => {
  return (
    <footer className="text-white py-20 bg-secondary/80 dark:bg-slate-950">
      <div className="container mx-auto px-6 sm:px-12 lg:px-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16 sm:pl-32">
          ...
          <div className="flex flex-col items-start max-w-xs">
            ...
            <button className="mt-6 bg-secondary text-white py-3 px-6 hover:bg-stone-900 transition-all duration-300">
              Review us
            </button>
          </div>
